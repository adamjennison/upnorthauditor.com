...
/**
 * Directorate filter form base class.
 *
 * @package    myshelf
 * @subpackage filter
 ...
 */
abstract class BaseDirectorateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('directorate_filters[%s]');
